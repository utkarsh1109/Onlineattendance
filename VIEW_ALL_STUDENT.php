...
<title>Display All Students Data</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark background-color: darkgrey;">
  ...
  <br>
  <div class="card-title bg-dark text-white text-center"><span style="color: White ;"><h4>View all the Students</h4></span></div>
  <br>
    ...
    <form method="post">
      ...
      <button type="submit" class="btn btn-info ml-3" style=" background-color: maroon" name="submit1"><h5>Click here</h5></button>
    </form> 
